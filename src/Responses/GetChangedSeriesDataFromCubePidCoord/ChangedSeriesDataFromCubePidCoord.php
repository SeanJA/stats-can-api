...
namespace SeanJA\StatsCanAPI\Responses\GetChangedSeriesDataFromCubePidCoord;
...
class ChangedSeriesDataFromCubePidCoord implements ResponseInterface, Deserializable
{
